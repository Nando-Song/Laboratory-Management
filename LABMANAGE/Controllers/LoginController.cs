    ...
    public class LoginController : Controller
    {
        ...
        public ActionResult GetBackPwdSubmit(string username,string Realname,string phone,string Email)
        {
            ...
            if (d2 != null)
            {
                ...
                string useraddress = GetConfig("useraddress");
                string mia = GetConfig("pass");
                System.Net.Mail.SmtpClient client = new System.Net.Mail.SmtpClient();
                client.Host = GetConfig("smtptype");//使用163的SMTP服务器发送邮件
                ...
                Message.From = new System.Net.Mail.MailAddress(useraddress);//这里需要注意，163似乎有规定发信人的邮箱地址必须是163的，而且发信人的邮箱用户名必须和上面SMTP服务器认证时的用户名相同
